// Package common implements the git pack protocol with a pluggable
...
func (c *client) NewSession(s string, ep *Endpoint, auth AuthMethod) (Session, error) {
	switch s {
	case UploadPackServiceName, ReceivePackServiceName:
	default:
...
func (s *session) DiscoverReferences(ctx context.Context, forPush bool, _ *SessionOptions) (*packp.AdvRefs, error) {
	if s.advRefs != nil {
