...
// Encode writes the UpdateRequests encoding to the stream.
...
func (req *UpdateRequests) encodeShallow(e *pktline.Encoder,
...
func (req *UpdateRequests) encodeCommands(e *pktline.Encoder,
...
func (req *UpdateRequests) encodeOptions(e *pktline.Encoder,
	opts []*Option) error {
